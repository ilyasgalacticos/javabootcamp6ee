...
<div class="container mt-5">
    <div class="row">
        <div class="col-6 mx-auto">
            ...
            <div class="row">
                <div class="col-12">
                    <input type="text" class="form-control"
                           ...
                           value="<%=item.getCountry().getName() + " - " + item.getCountry().getCode()%>" readonly>
                </div>
            </div>
            <div class="row mt-3">
                <div class="col-12">
            ...
            <div class="row">
                <div class="col-12">
                    <input type="text" class="form-control" value="<%=item.getUser().getFullName()%>" readonly>
                </div>
            </div>
            <%
                if (currentUser != null && item.getUser().getId() == currentUser.getId()) {
            %>
            <div class="row mt-3">
                <div class="col-12">
